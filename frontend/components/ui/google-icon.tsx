// The standard four-color "G" mark from Google's own Sign-in-with-Google brand guidelines —
// this exact icon is what any third-party "Continue with Google" button is expected to use.
